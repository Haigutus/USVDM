...
class OPDMservice():
    ...
    class operations:
        ...
        GetContentResult = """  <?xml version="1.0" encoding="UTF-8"?>
                                <sm:GetContent xmlns="http://entsoe.eu/opde/ServiceModel/1/0"
                                               ...
                                               xmlns:opdm="http://entsoe.eu/opdm/ObjectModel/1/0">
                                    <sm:returnOverSOAP>True</sm:returnOverSOAP> <!-- TO BE ADDED -->
    ...
    def get_content(self, content_id):
        ...
        new_GetContentResult = new_GetContentResult.format(content_id)
...
if __name__ == '__main__':
    ...
    #server = 'https://er-opde-single-host-02.elering.sise:8443'
    server = 'https://er-opde-acceptance.elering.sise:8443'
    service = OPDMservice(server, debug=True)
...
##    print(json.dumps(xmltodict.parse(etree.tostring(response), xml_attribs = False), indent = 4))
    ...
    #query_id, response = service.query_object(object_type="IGM", metadata_dict = {'pmd:scenarioDate': '2019-06-07T00:30:00', 'pmd:timeHorizon': '1D'})
    query_id, response = service.query_object(object_type="IGM", metadata_dict={'pmd:timeHorizon': 'YR'})
